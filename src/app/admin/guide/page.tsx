    ...
    <div style={{ maxWidth: "800px" }}>
      ...
      <div className="admin-card">
        ...
        <ul style={{ paddingLeft: "20px", fontSize: "0.9375rem", lineHeight: 1.8, color: "var(--ink)" }}>
          ...
          <li>
            <strong>सेवाहरू (Services):</strong> सेवा खण्डको सम्पादन दुई तहमा हुन्छ।
            पहिलो पृष्ठमा तीन वर्गहरू (नोटरी पब्लिक, कानुनी सेवा, मेलमिलाप) को
            शीर्षक, उप-शीर्षक र सूचना परिवर्तन गर्न सकिन्छ, साथै क्रम मिलाउन वा
            नयाँ वर्ग थप्न सकिन्छ। प्रत्येक वर्गको &quot;समूह र सेवाहरू सम्पादन गर्नुहोस् →&quot;
            बटन थिच्दा दोस्रो पृष्ठ खुल्छ — त्यहाँ सम्बन्धित समूहका शीर्षकहरू
            (खाली राख्दा बाहिर देखिँदैन), प्रत्येक समूहभित्रका सेवाहरू थप/हटाउन,
            क्रम मिलाउन र पाठ परिवर्तन गर्न सकिन्छ।
          </li>
          <li>
